    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authz -> authz
                ...
                .requestMatchers(
                    "/rules/evaluate/price",
                    "/api/rules/evaluate/price",
                    "/support/rules/evaluate/price",
                    "/api/support/rules/evaluate/price",
                    "/api/v1/support/rules/evaluate/price"
                ).permitAll()
                .requestMatchers("/tickets/*/qr", "/api/tickets/*/qr").permitAll()
